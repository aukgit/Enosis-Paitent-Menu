...
*/
$.fn.extend({getAllClasses:function(){return this.length===1?this.attr("class").split(/\s+/):null}});$.devOrg={genericComboClass:"devCombo",getAllClasses:function(n){return n.getAllClasses()},getClassesExcept:function(n,t){var u,r,i;if(n===null||n===undefined)return[];if(t===null||t===undefined)return n;for(u=n.length,r=[],i=0;i<u;i++)t.indexOf(n[i])===-1&&r.push(n[i]);return r},countryFlagRefresh:function(n,t,i){var u=$.queryAll(n).selectpicker(),f=$.queryAll(t),r=$.queryAll(i),e=["flag-country-combo","flag"],o=["btn","dropdown-toggle","selectpicker","btn-success","flag-combo"];u.change(function(){for(var i=f.find("li.selected"),u=i.find("a"),s=u.getAllClasses(),h=r.getAllClasses(),c=$.devOrg.getClassesExcept(s,e),t=$.devOrg.getClassesExcept(h,o),n=0;n<t.length;n++)r.removeClass(t[n]);r.addClass("fc-"+c[0])})},countryRelatedToPhone:function(n,t,i,r){function e(){var i=s.find("li.selected"),r=i.find("a > span").text().toString(),t=$.devOrg.getTextBetween(r,"(",")"),n=f.val();t=$.devOrg.replaceStartsWith(t,"+","");n=_.isEmpty(n)||_.isEmpty(u)||!$.devOrg.isStartsWith(n,u)?t+n:$.devOrg.replaceStartsWith(n,u,t);u=t;f.val(n)}var o=$.queryAll(n),s=$.queryAll(t),f=$.queryAll(r),u="";o.ready(e).change(e)},getTextBetween:function(n,t,i){var r,u;return _.isString(n)&&(r=n.indexOf(t),r>-1&&(u=n.indexOf(i),u>-1))?n.substr(r+1,u-r-1):null},getComboString:function(n,t,i,r,u){i=_.isEmpty(i)?"":" id='"+i+"' ";_.isEmpty(t)&&(t="");_.isEmpty(r)&&(r="");n=_.isEmpty(n)?"":" name='"+n+"' ";return"<select "+n+" class='"+$.devOrg.genericComboClass+" form-control "+t+" selectpicker'"+i+" data-style='"+t+"' "+u+" data-live-search='true'>"+r+" <\/select>"},getComboOptionsStringFromJson:function(n,t,i){var r;if(_.isEmpty(i)&&(i=""),_.isEmpty(t)&&(t=""),n.length>0){var f=n.length,e=new Array(f+5),u=" selected='selected' ",o="<option class='"+i+"'";for(r=0;r<f;r++)r!==0&&u!==""&&(u=""),e[r]=o+u+" value='"+n[r].id+"'>"+t+n[r].display+"<\/option>";return e.join("")}return""},getWholeComboStringWithJsonItems:function(n,t,i,r,u,f,e){var o=$.devOrg.getComboOptionsStringFromJson(n,f,e);return $.devOrg.getComboString(t,i,r,o,u)},smartDependableCombo:function(n,t,i,r,u,f,e,o,s,h){function v(){c.length>0?c.hide():console.error.log("devOrg->smartDependableCombo: main div not found for '"+t+"'")}function y(){var n=l.find("select, div.bootstrap-select");n.length>0&&n.remove()}function p(n){var i=$.devOrg.getWholeComboStringWithJsonItems(n,u,e,f,o,h,s),t;l.prepend(i);t=l.find("select");t.selectpicker()}var a=$.queryAll(n),c,l;if(_.isEmpty(a)){console.error.log("error raised from developers organism component's smartDependableCombo that no parent is detected.");return}c=$.queryAll(t);l=c.find(i);v();a.change(function(){var n=a.val(),u=r+"/"+n;$.ajax({type:"POST",dataType:"JSON",url:u,success:function(n){if(n.length===0){v();return}l=$.queryAll(t+" "+i);y();c.show("slow");p(n)},error:function(){v()}})})},bootstrapComboSelectbyFindingValue:function(n,t){$(n).selectpicker("val",t).trigger("change")},bootstrapComboSelectIndex:function(n,t){var i=$.queryAll(n+">option"),r,u;i.length>0&&t<=i.length-1&&(r=$(i[t]),u=r.val(),$.devOrg.bootstrapComboSelectbyFindingValue(n,u))},isStartsWith:function(n,t){if(_.isString(n)){var i=n.substr(0,t.length);if(i===t)return!0}return!1},replaceStartsWith:function(n,t,i){var u,r,f;return _.isString(n)&&!_.isEmpty(t)&&(u=n.substr(0,t.length),u===t)?(r=t.length,f=n.substr(r,n.length-r),i+f):n},enterToNextTextBox:function(n,t){var r=$.queryAll(n),i;r.find("input:text:first-child").focus();i="input[type='text']:visible,input[type='password']:visible,input[type='numeric']:visible,input[type='email']:visible,button.selectpicker[type='button']:visible,select:visible";r.on("keypress",i,function(r){var e=r.keyCode||r.which,f,u;e===13&&(r.preventDefault(),f=$(i).length,u=$(i).index(this)+1,u<f?$(i)[u].focus():($(i)[u-1].blur(),t===!0&&$(n).submit()))})},validateTextInputBasedOnRegEx:function(n,t,i){$(n).attr("data-val-regex-pattern",t);_.isEmpty(i)||$(n).attr("data-val-regex",i)},reSetupjQueryValidate:function(n){var t=$(n).removeData("validator").removeData("unobtrusiveValidation");$.validator.unobtrusive.parse(t)},validateTextInputsBasedOnHiddenSpansGiven:function(n){var i=$(n),s="data-min",s="data-min",u,r,t;if(i.length>0)for(u="input[type='text'],input[type='password'],input[type='email'],input[type='numeric'],select:visible",r=i.find(u),t=0;t<r.length;t++){var f=$(r[t]),e=f.attr("name"),o=i.find("span[data-name='"+e+"']:hidden");o.length>0}},validateInputFromServer:function(n,t,i,r,u,f,e,o,s,h,c){var a=0,l=$(n);l.length>0&&(l.removeAttr("isDisable"),e||l.keyup(function(){$.queryAll("#validation #id").val(l.val())}).focus(function(){$.queryAll("#validation #id").val(l.val())}),l.blur(function(){var tt,ft;if(e||$.queryAll("#validation #id").val(l.val()),tt=l.val(),!_.isEmpty(tt)&&!(tt.length<f)){_.isEmpty(s)&&(s="is available and valid.");_.isEmpty(o)&&(o="is not valid or already exist. Your input can't contain ( [ ] ' , * & ? \" ) or space or any other special character for this data-type.");ft=h===null||h===undefined||h.length==0?e?l.closest("form").serializeArray():$.byId("validation").serialize():h.serializeArray();var et="span.CustomValidation."+i,st=$("input[name=__RequestVerificationToken]").val(),v="glyphicon-refresh",y="glyphicon-spin",p="hide",b="green",d="red",w="glyphicon-ok",k="glyphicon-remove",n=$(et),g=n.attr("data-display"),it=g+" "+s,rt="data-invalid",ut=g+" "+o,ot="a.CustomValidation."+i+".tooltip-show",nt=$(ot);(n.removeClass(k).removeClass(w),n.hasClass(v)||n.addClass(v),n.hasClass(y)||n.addClass(y),n.hasClass(p)&&n.removeClass(p),nt.attr("data-original-title","Validating "+g).attr("title","Validating "+g),c!==null&&c!==undefined&&a>c)||$.ajax({type:"POST",dataType:"JSON",url:t,data:ft,success:function(t){a=a+1;n.hasClass(v)&&n.removeClass(v);n.hasClass(y)&&n.removeClass(y);n.hasClass(p)&&n.removeClass(p);t==!0?(n.hasClass(k)&&n.removeClass(k),n.hasClass(d)&&n.removeClass(d),n.addClass(b).addClass(w).attr("title",it),nt.attr("title",it).attr("data-original-title",it),u&&l.prop("isDisable",!0),l.addClass("bold").addClass("green").next().focus(),l.removeAttr(rt)):(n.hasClass(b)&&n.removeClass(b),n.hasClass(w)&&n.removeClass(w),l.prop("isDisable",!1).addClass("bold").addClass("red"),n.addClass(d).addClass(k).attr("title",ut),nt.attr("title",ut).attr("data-original-title",ut),r===!0&&l.focus(),l.attr(rt,"true"));$(".tooltip-show").tooltip()},error:function(t,i,r){n.hasClass(v)&&n.removeClass(v);n.hasClass(y)&&n.removeClass(y);n.hasClass(p)&&n.removeClass(p);n.hasClass(w)&&n.removeClass(w);n.hasClass(b)&&n.removeClass(b);l.prop("isDisable",!1).addClass("bold").addClass("red");n.addClass(d).addClass(k).attr("title",r);nt.attr("title",i).attr("data-original-title",r);$(".tooltip-show").tooltip();l.attr(rt,"true")}})}}))},fillRegisterFieldsOnDemo:function(){var i=0,t=$(".form-group"),n=t.find("input[type=text]");$.each(n,function(){this.value=1111111111111});n=t.find("input[type=password]");$.each(n,function(){this.value="asdf1234@"});n=t.find("input[type=number]");$.each(n,function(){this.value=i++});n=t.find("textarea");$.each(n,function(){this.value="1111111111111"});n=t.find("input[type=email]");$.each(n,function(){this.value="auk.junk@live.com"});n=t.find("input[type=checkbox]");$.each(n,function(){this.prop("checked",!0)})},bootstrapTabsMordernize:function(n){var t=$(n),i,r;if(t.length>0){i=$(".tab-content input[type='hidden'][name='tab']");i.length>0&&(r=i.val(),_.isEmpty(r)?t.find("li > a:first").tab("show"):t.find("li>a[href='"+r+"']").tab("show"));t.click(function(n){n.preventDefault();$(this).tab("show")});$("ul"+n+".nav-tabs > li > a").on("shown.bs.tab",function(n){var t=$(n.target).attr("href");i.val(t)})}},ratingMordernize:function(){var n=$(".rating-5");n.length>0&&n.rating({showClear:!1});n=$(".rating-10");n.length>0&&n.rating({showClear:!1,starCaptionClasses:{.5:"label label-danger",1:"label label-danger",1.5:"label label-danger",2:"label label-danger",2.5:"label label-danger",2:"label label-warning",2.5:"label label-warning",3:"label label-warning",3.5:"label label-warning",4:"label label-warning",4.5:"label label-warning",5:"label label-warning",5.5:"label label-info",6:"label label-info",6.5:"label label-info",7:"label label-info",7.5:"label label-primary",8:"label label-primary",8.5:"label label-success",9:"label label-success",9.5:"label label-success",10:"label label-success"}})},uxFriendlySlide:function(n,t,i){var r=$(n+" [data-dev-slide][data-dev-visited='false']"),u=0,f=r.length,e=0;f>0&&(r.hide(),e=u,r.filter("[data-dev-slide='"+u+++"'][data-dev-visited='false']").show(),$(n).submit(function(n){n.preventDefault();var o=r.filter("[data-dev-slide='"+u+"'][data-dev-visited='false']"),e,f;o.length>0?(e=r.filter("[data-dev-slide='"+(u-1)+"']"),f=e.find("input, textarea"),f.length>0&&$.devOrg.checkValidInputs(f)&&(t||e.hide("slow"),o.prop("data-dev-visited")||(o.attr("data-dev-visited","true"),o.show("slow"),u++))):(e=r.filter("[data-dev-slide='"+(u-1)+"']"),f=e.find("input"),f.length>0&&$.devOrg.checkValidInputs(f)&&(i||this.submit()))}))},checkValidInputs:function(n){var i=null,f=n.length,r,u,t;if(f>0)for(r=0;r<f;r++){if(i=$(n[r]),i.hasClass("common-rating")){if(u=i.closest("div.rating-container"),t=u.closest("div.star-rating"),i.val()==="0")return u.css({"text-shadow":"2px 2px red"}),t.attr("data-warned")||(t.append("<label class='label label-danger small-font-size'>Please rate first.<\/label>"),t.attr("data-warned","true")),!1;u.css({"text-shadow":"none"});t.attr("data-warned")&&(t.find("label").remove(),t.attr("data-warned","false"))}if(!i.valid())return!1}return!0}};$.frontEndApp={transactionStatushdie:function(){var n=$.queryAll(".transaction-status");n.length>0&&n.delay(1500).fadeOut(2500)},execute:function(){var f=new WOW({boxClass:"wow",animateClass:"animated",offset:100,mobile:!1}),n,t,i,r,u;f.init();n=$.queryAll("ul.enosis-paitent-menu>.dropdown");n.length>0&&n.hover(function(){var t=$(this),n;t.addClass("open");n=t.find(".icon-wrapper");n.length>0&&n.addClass("animated pulse")},function(){var n,t;$(this).removeClass("open");n=$(this);n.removeClass("open");t=n.find(".icon-wrapper");t.length>0&&t.removeClass("animated pulse")});t=$.queryAll(".rating-5-front");t.length>0&&t.rating({showClear:!1,showCaption:!1});i=$.queryAll(".rating-5-page-details");i.length>0&&i.rating({showClear:!1,showCaption:!0,starCaptions:{0:"0",.5:"0.5",1:"1",1.5:"1.5",2:"2",2.5:"2.5",3:"3",3.5:"3.5",4:"4",4.5:"4.5",5:"5"},starCaptionClasses:{0:"label label-danger",.5:"label label-danger",1:"label label-danger",1.5:"label label-warning",2:"label label-warning",2.5:"label label-info",3:"label label-info",3.5:"label label-primary",4:"label label-primary",4.5:"label label-success",5:"label label-success"}});r=$.queryAll(".tooltip-show");r.length>0&&r.tooltip();u=$.queryAll(".seo-hide");u.length>0&&u.hide();$.frontEndApp.transactionStatushdie()}};$(function(){$.frontEndApp.execute()});
//# sourceMappingURL=FrontEndJs.min.js.map
